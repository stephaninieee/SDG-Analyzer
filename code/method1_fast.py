...
df = pd.read_excel("../code/new_SDGs_keywords.xlsx", header=1)
...
# ws_driver = torch.load('../code/model/ws_driver.pkl')
# ch_st_model = torch.load('../code/model/ch_st_model.pkl')
# ch_kw_model = KeyBERT(model=ch_st_model)
# en_st_model = torch.load('../code/model/en_st_model.pkl')
# en_kw_model = KeyBERT(model=en_st_model)
...
def get_en_keywords(text):
    ...
    # en_kw_model = torch.load('../code/model/en_st_model.pkl')
    en_kw_model = KeyBERT(model=torch.load('../code/model/en_st_model.pkl'))
...
def get_zh_keywords(text):
    ...
    ws_driver = torch.load('../code/model/ws_driver.pkl')
    # ch_kw_model = torch.load('../code/model/ch_st_model.pkl')
    ch_kw_model = KeyBERT(model=torch.load('../code/model/ch_st_model.pkl'))
    stoplist_path = r"../code/中文分隔詞詞庫.txt"
...
def print_sdg_results(paragraphSDG):
